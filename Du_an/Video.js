  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View>
        ...
        <View>
         <Image style={{width:350,height:200,marginTop:20,marginLeft:30}} source={require('./img/video1.png')}/>
        ...
        <View>
         <Image style={{width:350,height:200,marginTop:20,marginLeft:30}} source={require('./img/video2.png')}/>
         <Text style={{fontSize:20,marginLeft:60,marginTop:10,color:'#F9B1B9'}}>Video chụp ảnh cưới của gia đình</Text>
         <Text style={{marginLeft:300,marginTop:20}}>Xem chi tiết...</Text>
        </View>
        </View>
